...
const icons: Record<string, string> = {
  ...
  arrowRight: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />',
...
const iconPath = icons[props.name] || icons.home
</script>

<template>
  <svg
    :class="'inline-block flex-shrink-0 ' + (props.iconClass || '')"
    :width="size"
    :height="size"
    viewBox="0 0 24 24"
    fill="none"
